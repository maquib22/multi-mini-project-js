...
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.cssText = ' background: linear-gradient(rgba(0,0,0.8), rgba(0,0,0,0.7)), url(images/bg1.jpeg) center no-repeat; background-size: cover;';
})